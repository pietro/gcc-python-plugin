...
CXXFLAGS+= -fPIC -fno-strict-aliasing -Wall -Wextra -fno-rtti  -Wno-error=cast-function-type
LIBS+= $(PYTHON_LIBS)
...
$(LIBGCC_C_API_SO): $(pwd)/gcc-c-api
	cd gcc-c-api && make $(if $(srcdir),-f $(srcdir)./gcc-c-api/Makefile) libgcc-c-api.so CXX=$(CXX) $(if $(srcdir),srcdir=$(srcdir)./gcc-c-api/)
...
$(PLUGIN_OBJECT_FILES): %.o: %.c autogenerated-config.h gcc-python.h $(LIBGCC_C_API_SO) autogenerated-EXTRA_CFLAGS.txt
	$(COMPILE.cc) $(shell cat autogenerated-EXTRA_CFLAGS.txt) $(OUTPUT_OPTION) -I$(srcdir)./ -I$(srcdir)./gcc-c-api -I./gcc-c-api $<
