...
from cpybuilder import PyMethodTable, PyGetSetDef, PyGetSetDefTable, CompilationUnit
...
def generate_location():
    ...
    cu.add_defn("""
static PyObject *
PyGccLocation_get_file(struct PyGccLocation *self, void *closure ATTRIBUTE_UNUSED)
{
...
""")
    ...
    cu.add_defn("""
static PyObject *
PyGccLocation_get_line(struct PyGccLocation *self, void *closure ATTRIBUTE_UNUSED)
{
...
""")
    ...
    cu.add_defn("""
static PyObject *
PyGccLocation_get_column(struct PyGccLocation *self, void *closure ATTRIBUTE_UNUSED)
{
...
""")
    if get_gcc_version() >= 7000:
        cu.add_defn("""
static PyObject *
PyGccLocation_get_caret(struct PyGccLocation *self, void *closure ATTRIBUTE_UNUSED)
{
...
""")
        cu.add_defn("""
static PyObject *
PyGccLocation_get_start(struct PyGccLocation *self, void *closure ATTRIBUTE_UNUSED)
{
...
""")
        cu.add_defn("""
static PyObject *
PyGccLocation_get_finish(struct PyGccLocation *self, void *closure ATTRIBUTE_UNUSED)
{
...
""")
    ...
    getsettable = PyGetSetDefTable(
        "PyGccLocation_getset_table",
        [
            PyGetSetDef(
                "file", "PyGccLocation_get_file", None, "Name of the source file"
            ),
            PyGetSetDef(
                "line", "PyGccLocation_get_line", None, "Line number within source file"
            ),
            PyGetSetDef(
                "column",
                "PyGccLocation_get_column",
                None,
    ...
    if get_gcc_version() >= 7000:
        getsettable.gsdefs += [
            ...
            PyGetSetDef(
                "start", "PyGccLocation_get_start", None, "Starting location of range"
            ),
            PyGetSetDef(
                "finish", "PyGccLocation_get_finish", None, "End location of range"
            ),
        ]
    ...
    pytype = PyGccWrapperTypeObject(
        identifier="PyGccLocation_TypeObj",
        localname="Location",
